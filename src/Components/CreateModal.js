            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <form onSubmit={handleSubmit.bind(this)}>
                        ...
                        <div className="form-group">
                            <TextField color='primary' valuerequired={true} fullWidth={true} id="standard-basic" label="Amount Sent" type="number" name="amount_send" onChange={handleChange.bind(this)} />
                        </div>
                        <div className="form-group">
