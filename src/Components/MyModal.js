...
import { addMyExpense } from '../actions/my_expense'
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <form onSubmit={handleSubmit.bind(this)}>
                        <div className="form-group">
                            <TextField color='primary' required ={true} fullWidth={true} id="standard-basic" label="Month" type="text" name="month" onChange={handleChange.bind(this)}  />
                        </div>
                        <div className="form-group">
